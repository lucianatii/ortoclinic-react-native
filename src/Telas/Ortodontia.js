...
export default function Ortodontia({ navigation }) {

  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      <View>
        <Image style={{ width: 450, height: 300, borderRadius: 6, paddingBottom: 10 }} source={require('../img/d1.jpg')} />
      </View>
      <Text></Text>

      <View style={{ flexDirection: 'row' }}>
        <View style={estilos.marcadorD} />
        <Text style={estilos.tituloD}>Ortodontia</Text>
      </View>
      <View >
        <Text></Text>
