...
export default function FacetasR({ navigation }) {

  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      <View>
        <Image style={{ width: 450, height: 300, borderRadius: 6, paddingBottom: 10 }} source={require('../img/g1.jpg')} />
      </View>
      <Text></Text>

      <View style={{ flexDirection: 'row' }}>
        <View style={estilos.marcadorD} />
        <Text style={estilos.tituloD}>Facetas em Resina</Text>
      </View>
      <View >
        <Text></Text>
