...
export default function ProteseD({ navigation }) {

  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      <View>
        <Image style={{ width: 450, height: 300, borderRadius: 6, paddingBottom: 10 }} source={require('../img/e1.jpg')} />
      </View>
      <Text></Text>

      <View style={{ flexDirection: 'row' }}>
        <View style={estilos.marcadorD} />
        <Text style={estilos.tituloD}>Prótese Dentária</Text>
      </View>
      <View >
        <Text></Text>
